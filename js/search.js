...
var meta = {
  ...
  "keywords": {
    ...
    "can": {
      ...
      "17": { "UpgradeTo350": 6 },
      "18": { "Button": 5 },
      "19": { "GlobalVariables": 4 },
      "20": { "Templates": 3 },
      "21": { "Tumbleweed_movement": 2 },
      "22": { "Setup": 1 }
    },
    "can't": {
      "0": { "Character": 2 },
    ...
    "different": {
      ...
      "3": { "acintro3": 4 },
      "4": { "GlobalVariables": 3 },
      "5": { "TroubleshootingWindowsZoneID": 2 },
      "6": { "CustomDialogOptions": 1 }
    },
    "Different": {
      "0": { "Multimedia": 1 }
    ...
    "does": {
      ...
      "5": { "Multimedia": 4 },
      "6": { "Dictionary": 3 },
      "7": { "TroubleshootingWindowsZoneID": 2 },
      "8": { "EditorView": 1 }
    },
    "doesn't": {
    ...
    "editor": {
      ...
      "4": { "EditorRoom": 4 },
      "5": { "UpgradeTo33": 3 },
      "6": { "TroubleshootingWindowsZoneID": 2 },
      "7": { "EditorView": 1 }
    },
    "EDITOR": {
      "0": { "TroubleshootingWindowsZoneID": 1 }
    ...
    "it's": {
      ...
      "1": { "acintro2": 5 },
      "2": { "FAQ": 4 },
      "3": { "TroubleshootingWindowsZoneID": 3 },
      "4": { "acintro8": 2 },
      "5": { "MusicAndSound": 1 }
    },
    "Italian": {
    ...
    "may": {
      ...
      "8": { "UpgradeTo33": 4 },
      "9": { "TroubleshootingWindowsZoneID": 3 },
      "10": { "CustomDialogOptions": 2 },
    ...
    "name": {
      ...
      "8": { "acintro1": 4 },
      "9": { "Hotspot": 3 },
      "10": { "TroubleshootingWindowsZoneID": 2 },
      "11": { "EditorView": 1 }
    },
    "named": {
      "0": { "OOProgramming": 4 },
    ...
    "null": {
      ...
      "5": { "String": 3 },
      "6": { "MusicAndSound": 2 },
      "7": { "DialogOptionsRenderingInfo": 1 }
    },
    "NULL": {
      "0": { "OOProgramming": 1 }
    },
    ...
    "property": {
      ...
      "14": { "acintro3": 4 },
      "15": { "UpgradeTo33": 3 },
      "16": { "DialogOptionsRenderingInfo": 2 },
      "17": { "CustomDialogOptions": 1 }
    },
    "PROPERTY": {
      "0": { "Object": 2 }
    },
    ...
    "setting": {
      ...
      "4": { "EditingGUIs": 5 },
      "5": { "Hotspot": 4 },
      "6": { "DialogOptionsRenderingInfo": 3 },
      "7": { "MusicAndSound": 2 },
      "8": { "CustomDialogOptions": 1 }
    },
    "Setting": {
    ...
    "where": {
      ...
      "2": { "acintro2": 9 },
      "3": { "Character": 6 },
      "4": { "TroubleshootingWindowsZoneID": 5 },
      "5": { "MusicAndSound": 4 },
    ...
    "whether": {
      ...
      "8": { "Multimedia": 3 },
      "9": { "RepExec": 2 },
      "10": { "TroubleshootingWindowsZoneID": 1 }
    },
    "Which": {
      "0": { "SourceControl": 2 },
      "1": { "acintro7": 1 }
