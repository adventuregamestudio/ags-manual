...
var meta = {
  "titles": {
    ...
    "Globalfunctions_Palette": "Gloabal functions: Palette Operations",
  ...
  "keywords": {
    ...
    "can": {
      ...
      "16": { "ScriptModules": 8 },
      "17": { "acintro5": 7 },
      "18": { "EditorInventoryItems": 6 },
      "19": { "Globalfunctions_Screen": 5 },
      "20": { "UpgradeTo32": 4 },
      "21": { "AudioClip": 3 },
      "22": { "ASCIIcodes": 2 },
      "23": { "Introduction": 1 }
    ...
    "Display": {
      ...
      "3": { "System": 18 },
      "4": { "Room": 16 },
      "5": { "Globalfunctions_Message": 14 },
      "6": { "Object": 10 },
      "7": { "Hotspot": 9 },
      "8": { "Globalfunctions_General": 8 },
      "9": { "Region": 7 },
      "10": { "File": 6 },
      "11": { "GUI": 5 },
      "12": { "ScriptingTutorialPart2": 4 },
      "13": { "DynamicSprite": 3 },
      "14": { "AudioClip": 2 },
      "15": { "Speech": 1 }
    },
    ...
    "do": {
      ...
      "9": { "UpgradeTo30": 5 },
      "10": { "TextParser": 4 },
      "11": { "DialogOptionsRenderingInfo": 3 },
      "12": { "acintro6": 2 },
      "13": { "Speech": 1 }
    },
    "dock": {
    ...
    "DrawingSurface": {
      ...
      "1": { "DynamicSprite": 19 },
      "2": { "Room": 6 },
      "3": { "DialogOptionsRenderingInfo": 3 },
      "4": { "UpgradeTo30": 2 },
      "5": { "CustomDialogOptions": 1 }
    },
    "DrawingSurface's": {
    ...
    "game": {
      ...
      "24": { "Lipsync": 4 },
      "25": { "Introduction": 3 },
      "26": { "ScriptingTutorialPart2": 2 },
      "27": { "ScriptingLanguage": 1 }
    },
    "game's": {
      "0": { "Settingupthegame": 13 },
      "1": { "DistGame": 4 },
    ...
    "int": {
      ...
      "10": { "Viewport": 15 },
      "11": { "ListBox": 14 },
      "12": { "Globalfunctions_Screen": 13 },
      "13": { "GUIControl": 12 },
      "14": { "Overlay": 11 },
      "15": { "AudioChannel": 10 },
      "16": { "ScriptingTutorialPart2": 9 },
      "17": { "DateTime": 8 },
      "18": { "Screen": 7 },
      "19": { "Slider": 6 },
      "20": { "Speech": 5 },
    ...
    "item": {
      ...
      "7": { "Set": 8 },
      "8": { "EventTypes": 7 },
      "9": { "TextScriptEvents": 6 },
      "10": { "ScriptingTutorialPart1": 5 },
      "11": { "ScriptKeywords": 4 },
      "12": { "acintro4": 3 },
      "13": { "GUI": 2 },
      "14": { "UpgradeTo33": 1 }
    ...
    "key": {
      ...
      "4": { "acintro7": 9 },
      "5": { "ASCIIcodes": 6 },
      "6": { "CustomDialogOptions": 5 },
      "7": { "System": 4 },
      "8": { "Game": 3 },
      "9": { "ScriptModules": 2 },
      "10": { "BlockingScripts": 1 }
    },
    "Key": {
      "0": { "ASCIIcodes": 2 },
      "1": { "BlockingScripts": 1 }
    ...
    "loop": {
      ...
      "7": { "ViewFrame": 5 },
      "8": { "UpgradeTo34": 3 },
      "9": { "DialogOptionsRenderingInfo": 2 },
      "10": { "GUI": 1 }
    },
    "looped": {
      "0": { "Character": 1 }
    ...
    "NOTE": {
      "0": { "Character": 31 },
      "1": { "Globalfunctions_General": 29 },
      "2": { "Object": 23 },
      "3": { "Game": 15 },
      "4": { "Region": 13 },
      "5": { "Settingupthegame": 12 },
      "6": { "String": 11 },
      "7": { "DrawingSurfaceFunctions": 10 },
      "8": { "DynamicSprite": 8 },
      "9": { "Speech": 7 },
      "10": { "ListBox": 6 },
      "11": { "Globalfunctions_Screen": 5 },
      "12": { "GUI": 4 },
      "13": { "acintro6": 3 },
      "14": { "Dialog": 2 },
      "15": { "IntegrationWithWindows": 1 }
    },
    "note": {
      "0": { "ScriptingTutorialPart1": 2 },
      "1": { "ScriptKeywords": 1 }
    ...
    "number": {
      ...
      "2": { "Game": 21 },
      "3": { "Object": 17 },
      "4": { "Globalfunctions_General": 16 },
      "5": { "Room": 15 },
      "6": { "File": 12 },
      "7": { "TextScriptEvents": 11 },
      "8": { "GUI": 9 },
      "9": { "ScriptKeywords": 8 },
      "10": { "DrawingSurfaceFunctions": 7 },
      "11": { "System": 6 },
      "12": { "ListBox": 5 },
      "13": { "GUIControl": 4 },
      "14": { "EditorView": 3 },
    ...
    "only": {
      ...
      "2": { "ScriptKeywords": 18 },
      "3": { "Speech": 12 },
      "4": { "DialogOptionsRenderingInfo": 10 },
      "5": { "Room": 9 },
      "6": { "Mouse": 7 },
      "7": { "Setup": 6 },
      "8": { "acintro6": 5 },
    ...
    "player": {
      ...
      "9": { "acintro3": 15 },
      "10": { "acintro7": 14 },
      "11": { "ScriptingTutorialPart1": 13 },
      "12": { "ScriptingTutorialPart2": 12 },
      "13": { "Mouse": 11 },
      "14": { "System": 10 },
      "15": { "Speech": 9 },
      "16": { "Setup": 8 },
      "17": { "TextParser": 7 },
      "18": { "Region": 6 },
      "19": { "TemplateSierraStyle": 5 },
      "20": { "MusicAndSound": 4 },
      "21": { "Parser": 3 },
      "22": { "DialogOptionsRenderingInfo": 2 },
      "23": { "Globalfunctions_Screen": 1 }
    },
    "Player": {
      "0": { "Room": 6 },
      "1": { "Region": 5 },
    ...
    "property": {
      ...
      "2": { "InventoryItem": 22 },
      "3": { "Room": 20 },
      "4": { "Settingupthegame": 14 },
      "5": { "Speech": 13 },
      "6": { "CustomProperties": 12 },
      "7": { "System": 11 },
      "8": { "Game": 10 },
      "9": { "acintro4": 9 },
      "10": { "GUI": 8 },
    ...
    "room": {
      ...
      "3": { "Camera": 19 },
      "4": { "Settingupthegame": 18 },
      "5": { "Globalfunctions_General": 15 },
      "6": { "DrawingSurfaceFunctions": 13 },
      "7": { "AdvancedRoomFeatures": 12 },
      "8": { "Viewport": 11 },
      "9": { "acintro7": 10 },
      "10": { "EventTypes": 9 },
      "11": { "DynamicSprite": 8 },
      "12": { "EditorRoom": 6 },
      "13": { "GUI": 5 },
      "14": { "Globalfunctions_Screen": 4 },
      "15": { "TextParser": 3 },
      "16": { "ScriptingTutorialPart2": 2 },
      "17": { "acintro6": 1 }
    },
    "room's": {
      "0": { "Room": 11 },
    ...
    "screen": {
      ...
      "1": { "Viewport": 21 },
      "2": { "Settingupthegame": 20 },
      "3": { "GUI": 19 },
      "4": { "Globalfunctions_General": 18 },
      "5": { "Room": 14 },
      "6": { "DrawingSurfaceFunctions": 13 },
      "7": { "Overlay": 12 },
      "8": { "Speech": 9 },
    ...
    "See": {
      ...
      "15": { "Overlay": 8 },
      "16": { "Set": 7 },
      "17": { "Settingupthegame": 6 },
      "18": { "Parser": 5 },
      "19": { "Globalfunctions_Screen": 4 },
      "20": { "TextScriptEvents": 3 },
      "21": { "Preprocessor": 2 },
      "22": { "UpgradeTo32": 1 }
    },
    "see": {
    ...
    "you": {
      ...
      "31": { "ScriptModules": 10 },
      "32": { "StringFormats": 9 },
      "33": { "BlockingScripts": 8 },
      "34": { "TheScriptHeader": 7 },
      "35": { "Globalfunctions_Screen": 6 },
      "36": { "AudioClip": 5 },
      "37": { "EditorInventoryItems": 4 },
